      ...
      <header className="flex items-start justify-between gap-3">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <h1 className="mt-2 text-3xl font-bold sm:text-4xl">Prepara annunci una volta, pubblica ovunque</h1>
            <p className="mt-2 max-w-2xl text-sm text-[var(--muted)] sm:text-base">
              Crea, salva e organizza i tuoi annunci con immagini multiple, poi copia testi e contenuti dove ti serve.
            </p>
          </div>
        </div>
        <button
